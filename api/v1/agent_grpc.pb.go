...
func (c *agentClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*SimpleStatusResponse, error) {
	out := new(SimpleStatusResponse)
	err := c.cc.Invoke(ctx, "/v1.Agent/Push", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) GetTimeseriesChannels(ctx context.Context, in *GetTimeseriesChannelsRequest, opts ...grpc.CallOption) (*GetTimeseriesChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.Agent/GetTimeseriesChannels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Agent_Deregister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AgentServer).Deregister(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.Agent/Deregister",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).Deregister(ctx, req.(*DeregisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Agent_GetTimeseriesChannels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.Agent/GetTimeseriesChannels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Agent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Agent_Deregister_Handler,
		},
		{
