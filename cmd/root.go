...
import (
	"fmt"
	config "github.com/pennsieve/pennsieve-agent/cmd/config"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pennsieve-agent.yaml)")
