...
func InitializeDB() (*sql.DB, error) {
	...
	migrationPathLocal := viper.GetString("migration.local")

	log.Println("init db")
	log.Println("db.go migrationPath:", migrationPath)
	log.Println("db.go migrationPathLocal:", migrationPathLocal)
